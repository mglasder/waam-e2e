...
class FashionMNIST(Dataset):
    ...
    def __init__(self):
        ...
        fashion_df = pd.read_csv("/home/zhendi/wei/splines-nn/fashion-mnist_train.csv")
...
class MLP(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.a1 = BSplineActivation(num_activations=256, mode="linear", device=config.device)
        self.a2 = BSplineActivation(num_activations=128, mode="linear", device=config.device)
        self.a3 = BSplineActivation(num_activations=64, mode="linear", device=config.device)
...
class CNN(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.a1 = BSplineActivation(num_activations=self.c1, device=config.device)
